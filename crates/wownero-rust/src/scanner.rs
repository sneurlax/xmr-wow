//! Unified scanning implementation for Wownero wallets.
//!
//! This module provides wallet scanning functionality. Ported from monero-serai-mirror
//! (dalek v3) to wownero-oxide (dalek v4). Functions that relied on monero-serai's
...
// todo!() to allow compilation. They will be implemented using wownero-oxide's
...
///
/// TODO: Implement using wownero-oxide key derivation.
pub fn derive_keys(_seed_hex: &str, _network: &str) -> Result<DerivedKeys, String> {
    todo!("derive_keys: port from monero-serai Seed to wownero-oxide key derivation")
}

/// Derive an address from spend/view keys and network.
///
/// TODO: Implement using wownero-oxide address encoding.
pub fn derive_address(
    _public_spend: &EdwardsPoint,
    _public_view: &EdwardsPoint,
    _network: &str,
) -> Result<String, String> {
    todo!("derive_address: port to wownero-oxide address module")
}

/// Derive a subaddress.
///
/// TODO: Implement using wownero-oxide subaddress derivation.
pub fn derive_subaddress(
    ...
    todo!("derive_subaddress: port to wownero-oxide subaddress derivation")
}
...
///
/// TODO: Implement using wownero-oxide seed handling.
pub fn resolve_seed(_mnemonic: &str) -> Result<[u8; 32], String> {
    todo!("resolve_seed: port from monero-serai Seed to wownero-oxide")
}
...
///
/// TODO: Implement using wownero-oxide Scanner.
pub async fn scan_block_for_outputs_with_url(
    ...
    todo!("scan_block_for_outputs_with_url: port to wownero-oxide Scanner")
}
...
pub async fn scan_block_for_outputs_with_url_and_lookahead(
    ...
    todo!("scan_block_for_outputs_with_url_and_lookahead: port to wownero-oxide Scanner")
}
...
pub async fn scan_block_multi_wallet_with_url(
    ...
    todo!("scan_block_multi_wallet_with_url: port to wownero-oxide Scanner")
}
...
pub async fn scan_block_multi_wallet(
    ...
    todo!("scan_block_multi_wallet: port to wownero-oxide Scanner")
}
...
pub async fn scan_mempool_for_outputs(
    ...
    todo!("scan_mempool_for_outputs: port to wownero-oxide Scanner")
}
...
pub async fn scan_mempool_for_outputs_with_lookahead(
    ...
    todo!("scan_mempool_for_outputs_with_lookahead: port to wownero-oxide Scanner")
}
...
pub async fn scan_mempool_for_outputs_with_account_lookahead(
    ...
    todo!("scan_mempool_for_outputs_with_account_lookahead: port to wownero-oxide Scanner")
}
...
pub async fn scan_blocks_batch_with_url(
    ...
    todo!("scan_blocks_batch_with_url: port to wownero-oxide Scanner")
}
...
pub async fn scan_blocks_batch_multi_wallet_with_url(
    ...
    todo!("scan_blocks_batch_multi_wallet_with_url: port to wownero-oxide Scanner")
}

/// Process a raw batch response into scan results.
///
/// TODO: Implement using wownero-oxide transaction parsing.
pub fn process_batch_response(
    ...
    todo!("process_batch_response: port to wownero-oxide transaction parsing")
}
...
pub fn process_batch_multi_wallet_response(
    ...
    todo!("process_batch_multi_wallet_response: port to wownero-oxide")
}

/// Fetch a batch of blocks for pipelined scanning.
///
/// TODO: Implement using wownero-oxide RPC.
pub async fn fetch_blocks_batch_with_url(
    _url: &str,
    _start_height: u64,
    _count: u64,
) -> Result<FetchedBlocks, String> {
    todo!("fetch_blocks_batch_with_url: port to wownero-oxide RPC")
}
...
pub fn process_fetched_batch(
    ...
    todo!("process_fetched_batch: port to wownero-oxide Scanner")
}
...
pub fn process_fetched_batch_cached(
    ...
    todo!("process_fetched_batch_cached: port to wownero-oxide Scanner")
}
...
pub fn process_fetched_batch_multi_wallet(
    ...
    todo!("process_fetched_batch_multi_wallet: port to wownero-oxide Scanner")
}
...
pub fn process_fetched_batch_multi_wallet_cached(
    ...
    todo!("process_fetched_batch_multi_wallet_cached: port to wownero-oxide Scanner")
}
...
pub async fn scan_blocks_batch_with_history_url(
    ...
    todo!("scan_blocks_batch_with_history_url: port to wownero-oxide Scanner")
}
...
pub async fn fetch_blocks_batch_with_history_url(
    ...
    todo!("fetch_blocks_batch_with_history_url: port to wownero-oxide RPC")
}
