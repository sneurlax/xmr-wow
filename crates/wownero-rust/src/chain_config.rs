...
impl ChainConfig {
    ...
    pub fn wownero_testnet(rpc_url: String) -> Self {
        ChainConfig {
            ...
            genesis_hash: [
                0x2b, 0x19, 0xc3, 0x67, 0xb9, 0xd6, 0xc6, 0x2c, 0xa2, 0x3e, 0x8b, 0xb1, 0x1a,
                0x5e, 0xd8, 0x9a, 0x42, 0x07, 0x5b, 0x8a, 0x0a, 0x55, 0xb8, 0xe6, 0xad, 0xab,
                0x4a, 0x46, 0xb0, 0x12, 0xc8, 0xf8,
            ],
    ...
    pub fn wownero_mainnet(rpc_url: String) -> Self {
        ChainConfig {
            ...
            genesis_hash: [
                0xa8, 0xdb, 0x07, 0xc0, 0xcd, 0x33, 0x72, 0xe6, 0xe3, 0x6a, 0x1a, 0xa5, 0xb1,
                0x00, 0x4a, 0x44, 0xc6, 0x44, 0x6f, 0x77, 0xcd, 0xc8, 0xc5, 0x2a, 0x40, 0xdc,
                0x19, 0x44, 0x01, 0x4e, 0x6e, 0x23,
            ],
