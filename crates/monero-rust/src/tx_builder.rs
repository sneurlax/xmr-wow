...
//!
//! Ported from monero-serai-mirror (dalek v3) to monero-oxide (dalek v4).
...
//!
//! These will be implemented using monero-oxide's wallet::send module
//! when the XmrWallet adapter is ready.
//
...
pub mod native {
    ...
    ///
    /// TODO: Implement using monero-oxide's SignableTransaction.
    pub async fn create_transaction(
        ...
        todo!("create_transaction: port to monero-oxide SignableTransaction")
    }
    ...
    pub async fn create_transaction_with_decoys(
        ...
        todo!("create_transaction_with_decoys: port to monero-oxide SignableTransaction")
    }

    /// Fetch decoys for a set of inputs.
    ///
    /// TODO: Implement using monero-oxide's decoy selection.
    pub async fn fetch_decoys(
        _node_url: &str,
        _stored_outputs: &[StoredOutputData],
    ) -> Result<DecoyResult, String> {
        todo!("fetch_decoys: port to monero-oxide decoy selection")
    }
