// P2Pool for Monero - Monero variable-length integer encoding
// Copyright (c) 2024 p2pool-rs Developers
// SPDX-License-Identifier: GPL-3.0-only
//
// Monero uses unsigned LEB128 (variable-length base-128 little-endian) encoding
// for integers in its serialization format.
